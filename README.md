...
This is only a beginner project and is not fully usasble as your primary password manager yet, please use KeePassXC or other such trusted and open source software to store your passwords if you interested in using an offline password manager.
